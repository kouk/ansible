...
notes:
  ...
  - C(RAX_USERNAME) and C(RAX_API_KEY) obviate the use of a credentials file
  - C(RAX_REGION) defines a Rackspace Public Cloud region (DFW, ORD, LON, ...)
  - C(OS_TOKEN) contains a pre-generated Rackspace authentication token. See U(https://developer.rackspace.com/docs/cloud-identity/v2/api-reference/token-operations/)
  - C(OS_PROJECT_NAME) defines the default value for I(tenant_name).
"""
